#!/usr/bin/env bash
#
# Build FaderBridge.app - the macOS menu-bar bundle for the FaderPort ⇄ X32 bridge.
#
...
PROJECT="$ROOT/src/FaderBridge.App/FaderBridge.App.csproj"
RID="osx-arm64"
EXE="FaderBridge"

PUB="$ROOT/dist/publish-fader-bridge"
